...
const RotationContainer = styled.div`
  ...
  animation: ${(props) => rotate(props.startRotationDegrees)}
      ${(props) => props.startSpinningTime / 1000}s
      cubic-bezier(0.42, 0, 0.42, 1) 1s 1 normal forwards running,
    ${(props) => continueSpin(props.startRotationDegrees)}
      ${(props) => props.continueSpinningTime / 1000}s linear 1s 1 normal
      forwards running,
    ${(props) =>
        stopSpin(props.startRotationDegrees, props.finalRotationDegrees)}
      ${(props) => props.stopSpinningTime / 1000}s
      cubic-bezier(0.42, 0, 0.42, 1) 0s 1 normal forwards running;
`;
...
export const Wheel = (_a) => {
  ...
  useEffect(() => {
    ...
    var fontsToFetch = isCustomFont(
      fontFamily === null || fontFamily === void 0 ? void 0 : fontFamily.trim()
    )
      ? [fontFamily]
      : [];
    var _loop_1 = function (i) {
      ...
      if (data[i].image) {
        ...
        var img_1 = new Image();
        img_1.src =
          ((_k = data[i].image) === null || _k === void 0 ? void 0 : _k.uri) ||
          "";
