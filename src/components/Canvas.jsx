...
const drawWheel = (canvasRef, data, drawWheelProps, isDraggingOn, setIsDraggingOn) => {
...
const pointInSector=(x, y, center_x, center_y, radius, start_angle, end_angle) =>{
...
export const Canvas = (_a) => {
    ...
    return(
        <>
            <canvas ref={canvasRef3} width={width} height={height} style={{ position: 'absolute' }} />
            <canvas ref={canvasRef2} width={width} height={height} style={{ position: 'absolute' }} />
